...
_$ProductItemsModelImpl _$$ProductItemsModelImplFromJson(
        Map<String, dynamic> json) =>
    _$ProductItemsModelImpl(
...
Map<String, dynamic> _$$ProductItemsModelImplToJson(
        _$ProductItemsModelImpl instance) =>
    <String, dynamic>{
